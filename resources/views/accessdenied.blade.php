		...
		<hr>
			<form class="needs-validation" action="{{ url('/change-domain') }}" method="POST" novalidate>
				...
				<div class="form-group">
					...
					<small class="text-muted">
						<i class="fa fa-question-circle"></i> IF still facing the access denied error please contact <a target="_blank" href="https://codecanyon.net/item/eclass-learning-management-system/25613271/support">{{ __('Support') }}</a> {{ __('for updation in domain.') }}.
					</small>
