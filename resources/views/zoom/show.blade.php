        ...
        <div class="card-body">
          ...
          <div class="row">
			  <div class="col-md-4 mt-3">
				<h5 for="exampleInputSlug">{{ __('adminstaticword.MeetingID') }} :</h5>
				<p style="font-size:18px;">{{ $response['id'] }}</p>
			</div>
			
			  <div class="col-md-4 mt-3">
				<h5 for="exampleInputSlug">{{ __('adminstaticword.Meeting') }} Type :</h5>
			...
			<div class="col-md-4 mt-3">
				<h5 for="exampleInputSlug">{{ __('adminstaticword.Meeting') }} Topic : </h5>
			...
			<div class="col-md-4 mt-3">
				<h5 for="exampleInputSlug">{{ __('adminstaticword.Meeting') }} Agenda :</h5>
