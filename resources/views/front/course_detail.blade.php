            ...
            <div class="col-lg-4">
                <div class="about-home-icon text-white text-right">
                    <ul>
                        ...
                        <li><a href="{{ route('gift.view',['id' => $course->id, 'slug' => $course->slug ]) }}" title="gift"><i class="fa fa-gift rgt-10"></i><span>Gift This Course</span></li>
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="about-home-share text-center">
                                        <a href="https://calendar.google.com/calendar/r/eventedit?text={{ $course['title'] }}" target="__blank"><i class="fa fa-calendar"></i>&nbsp;{{ __('reminder') }}</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="about-home-share text-center">
                                                ...
                                                @if($rel->courses->discount_price == !NULL)
                                                    <div class="rate text-right">
                                                        <ul>
                                                            ...
                                                            <li><a><b><strike>{{ currency($rel->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true) }}</strike></b></a></li>
