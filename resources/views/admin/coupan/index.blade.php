...
<div class="col-md-4 col-lg-4">
  ...
  <a href="{{ route('coupon.create') }}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Add Coupan</a>
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="card-box">All Coupans</h5>
              </div>
              <div class="card-body">
                        ...
                        <div class="btn-group mr-2">
                          <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                  <a class="dropdown-item" href="{{ route('coupon.edit',$cpn->id) }}" class="btn btn-xs btn-success-rgba"><i class="feather icon-edit-2"></i>Edit</a>
