...
<div class="col-md-4 col-lg-4">
    <a href="{{ url('coupon') }}" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-arrow-left mr-2"></i>Back</a>
</div>
@endslot
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="txt-desc">(If Choose Yes then Coupon Code shows to all users)
                                        </small>
                                    </div>
                                    <div class="form-group">
