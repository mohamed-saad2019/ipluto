            ...
            <form action="{{ route('coupon.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                          <label class="text-dark">{{ __('adminstaticword.MaxUsageLimit') }}: <span class="text-danger">*</span></label>
                          <input required="" type="number" min="1" class="form-control" name="maxusage">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputDetails">{{ __('adminstaticword.CouponCodedisplayonfront') }}:<sup class="text-danger">*</sup></label><br>
