                    ...
                    <div class="col-md-12 align-self-center">
                        ...
                        <div class="infobar">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notoficationlink">
                                                <div class="notification-dropdown-title">
                                                    <h6>You have {{ Auth()->user()->unreadNotifications->where('type', 'App\Notifications\AdminOrder')->count() }} notifications</h6>                            
                                                </div>
                                                ...
                                                <div class="notification-dropdown-title">
                                                <a href="{{route('deleteNotification')}}"><p>Clear all</p></a>                            
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <div class="languagebar">
                                    <a href="{{ url('/') }}" target="_blank"><span class="live-icon">Visit Site</span></a>   
                                    </div>
                                </li>
                                <!-- = site visit end -->
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                                ...
                                                <div class="userbox">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="media dropdown-item">
                                                            <a href="{{ url('user/edit/'.Auth()->User()->id)}}" class="profile-icon"><img src="{{ url('admin_assets/assets/images/svg-icon/crm.svg') }}" class="img-fluid" alt="user">My Profile</a>
                                                        </li>
                                                                                                     
                                                        <li class="media dropdown-item">
                                                            <a href="{{ route('logout') }}" class="profile-icon"  onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><img src="{{ url('admin_assets/assets/images/svg-icon/logout.svg') }}" class="img-fluid" alt="logout">Logout</a>
