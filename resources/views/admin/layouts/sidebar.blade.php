                        ...
                        <ul class="vertical-menu">
                            <div class="logobar">
                                <a href="{{ url('/') }}" class="logo logo-large">
                                    <img style="object-fit:scale-down;"  src="{{url('images/iPluto_Logo_Animation.gif')}}"
                        ...
                        {{--     <li class="{{ Nav::isRoute('admin.index') }}">
                           ...
                           <li
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="javaScript:void();">
                                            <i class=""></i> <span>{{ __('adminstaticword.Secondary') }}</span><i
                                                class="feather icon-chevron-right"></i>
                                        </a>
                                        <ul class="vertical-submenu">

                                           {{-- <li class="{{ Nav::isResource('category') }}"><a
                                                    href="{{url('category')}}">{{ __('adminstaticword.Secondary') }}</a>
                                            </li>--}}
                                            <li class="{{ Nav::isResource('subcategory') }}"><a
                                                    href="{{url('subcategory')}}">{{ __('adminstaticword.Grades') }}</a>
                                            </li>
                                            <li class="{{ Nav::isResource('childcategory') }}"><a
                                                    href="{{url('childcategory')}}">{{ __('adminstaticword.subjects') }}</a>
                                            </li>

                                        <li class="{{ Nav::isResource('course') }}"><a
                                            href="{{url('course')}}"><span>{{ __('adminstaticword.Lessons') }}</span></a>
                                         </li>
                            ...
                            <li
                                class="{{ Nav::isRoute('user.index') }} {{ Nav::isRoute('user.add') }} {{ Nav::isRoute('user.edit') }}{{ Nav::isRoute('alluser.index') }} {{ Nav::isRoute('alluser.add') }} {{ Nav::isRoute('alluser.edit') }}{{ Nav::isRoute('allinstructor.index') }} {{ Nav::isRoute('allinstructor.add') }} {{ Nav::isRoute('allinstructor.edit') }}">
                                <a href="javaScript:void();">
                                    <i class="feather icon-users text-secondary"></i><span>{{ __('videos') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    ...
                                    <li>
                                        <a class="{{ Nav::isResource('user') }}"
                                            href="{{route('video.index')}}">{{ __('All Videos') }}</a>
                                    </li>
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('show/progress/report') }}">
                                        <a href="{{url('show/progress/report')}}">Progress {{ __('Report') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isResource('device-logs') }}">
                                        <a href="{{url('device-logs')}}">Device History  </a>
                                    </li>
                                </ul>
                            </li>
                            <!-- report end -->
                            ...
                            <li class="{{ Nav::isRoute('careers.page') }}">
                                <a href="{{route('careers.page')}}"><i class="feather icon-sidebar text-secondary"></i>{{ __('adminstaticword.Career') }}</a>
                            </li>
                            <!-- faq end -->
                            ...
                            <!-- front setting start  -->
                            <li
                                class="{{ Nav::isResource('slider') }} {{ Nav::isResource('facts') }} {{ Nav::isRoute('category.slider') }} {{ Nav::isResource('getstarted') }} {{ Nav::isResource('trusted') }} {{ Nav::isRoute('widget.setting') }} {{ Nav::isRoute('terms') }} {{ Nav::isResource('testimonial') }} {{ Nav::isResource('advertisement') }} {{ Nav::isResource('directory') }}">
                                <a href="javaScript:void();">
                                    <i
                                        class="feather icon-settings text-secondary"></i><span>{{ __('adminstaticword.FrontSetting') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('widget.setting') }}"><a
                                            href="{{route('widget.setting')}}">{{ __('adminstaticword.WidgetSetting') }}</a>
                                    </li>
                                    <li class="{{ Nav::isResource('testimonial') }}"><a
                                            href="{{url('testimonial')}}">{{ __('adminstaticword.Testimonial') }}</a>
                                    </li>
                                    <li class="{{ Nav::isResource('advertisement') }}"><a
                                            href="{{url('advertisement')}}">{{ __('adminstaticword.Advertisement') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isRoute('coloroption.view') }}">
                                        <a
                                            href="{{url('admin/coloroption')}}">{{ __('adminstaticword.ColorSettings') }}</a>
                                    </li>

                                    <li class="{{ Nav::isRoute('invoice/settings') }}">
                                        <a
                                            href="{{ url('invoice/settings') }}">{{ __('adminstaticword.InvoiceSettings') }}{{ __('') }}</a>
                                    </li>
                            ...
                            <!-- site setting start  -->
                            <li
                                class="{{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('api.setApiView') }} {{ Nav::isResource('blog') }} {{ Nav::isRoute('careers.page') }}  {{ Nav::isRoute('termscondition') }} {{ Nav::isRoute('policy') }} {{ Nav::isRoute('bank.transfer') }} {{ Nav::isRoute('show.pwa') }} {{ Nav::isRoute('adsense') }} {{ Nav::isRoute('ipblock.view') }} {{ Nav::isRoute('whatsapp.button') }}  {{ Nav::isResource('manualpayment') }} {{ Nav::isRoute('twilio.settings') }} {{ Nav::isRoute('show.sitemap') }} {{ Nav::isRoute('get.api.key') }} {{ Nav::isRoute('show.lang') }}">
                                <a href="javaScript:void();">
                                    <i
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('api.setApiView') }}">
                                        <a href="{{route('api.setApiView')}}">{{ __('adminstaticword.APISetting') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isRoute('show.pwa') }}">
                                        <a href="{{route('show.pwa')}}">{{ __('adminstaticword.PWASetting') }}</a>
                                    </li>
                                    <li class="{{ Nav::isRoute('adsense') }}">
                                        <a
                                            href="{{url('/admin/adsensesetting')}}">{{ __('adminstaticword.AdsenseSetting') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isRoute('twilio.settings') }}">
                                        <a
                                            href="{{route('twilio.settings')}}">{{ __('adminstaticword.TwilioSettings') }}</a>
                                    </li>
                                    ...
                                    <li class="{{ Nav::isRoute('maileclipse/mailables') }}">
                                        <a
                                            href="{{ url('maileclipse/mailables') }}">{{ __('adminstaticword.EmailSettings') }}{{ __('') }}</a>
                                    </li>
                            ...
                            {{-- <li class="{{ Nav::isRoute('appsettings.index') }}"><a
                                href="{{route('appsettings.index')}}">
                                <i
                                    class="feather icon-file-text text-secondary"></i><span>{{ __('adminstaticword.APPSetting') }}</span>
                            </a></li> --}}
