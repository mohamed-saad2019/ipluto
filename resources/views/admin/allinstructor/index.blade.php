...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
        ...
        <a href="{{route('allinstructor.add')}}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Add Instructor</a>
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">All Instructors</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <?php $i++;?>
                                            <tr>
                                                ...
                                                <form action="{{ route('user.quick',$user->id) }}" method="POST">
                                                    {{ csrf_field() }}
                                                    <label class="switch">
                                                        <input class="user" type="checkbox"  data-id="{{$user->id}}" name="status" {{ $user->status == '1' ? 'checked' : '' }}>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                            <a class="dropdown-item" href="{{ route('allinstructor.edit',$user->id) }}"><i class="feather icon-edit mr-2"></i>Edit</a>
                                                    ...
                                                    <div class="modal fade bd-example-modal-sm" id="delete{{$user->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form method="post" action="{{ route('user.delete',$user->id) }}" class="pull-right">
                                                                        {{csrf_field()}}
                                                                        {{method_field("DELETE")}}
