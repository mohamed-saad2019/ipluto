...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
        ...
        <a href="{{route('alluser.add')}}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Add Student</a>
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="box-title">All Students</h5>
                    </div>
                    <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                            <a class="dropdown-item" href="{{ route('alluser.edit',$user->id) }}"><i class="feather icon-edit mr-2"></i>Edit</a>
