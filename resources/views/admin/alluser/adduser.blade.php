               ...
               <div class="form-group" id="">
                ...
                <div class="form-group" id="">
                  <label class="text-dark" for="class_key">Class Code</label>
                   <input type="text" id="class_key" name="class_key" value="{{old('class_key')}}" minlength ="5" maxlength="5" class="form-control{{ $errors->has('class_key') ? ' is-invalid' : '' }}"  placeholder="Write Your Class Code" class="form-control">
