...
@slot('heading')
{{  __('adminstaticword.Subcategories') }}
@endslot
...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    ...
    <button type="button" class="float-right btn btn-primary-rgba mr-2" data-toggle="modal" data-target="#create">
      <i class="feather icon-plus mr-2"></i>Add Grade</button>
    </a>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-box">All Grades</h5>
        </div>
        <div class="card-body">
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>{{ __('adminstaticword.stage') }}</th>
                  ...
                  <td>
                    ...
                    <div class="modal fade bd-example" id="edit{{$cat->id}}" role="dialog"
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleSmallModalLabel">Edit Grade</h5>
                    ...
                    <div class="modal fade bd-example-modal-sm" id="create" role="dialog" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleSmallModalLabel">Add Grade</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
