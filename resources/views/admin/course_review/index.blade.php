            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-box">All Coursereviews</h5>
                    </div>
                    <div class="card-body">
...
$.ajaxSetup({
 ...
 $(function() {
    $('.coursereviewfeaturedstatus').change(function() {
    ...
    var id = $(this).data('id');
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{url('/quickupdate/featured/course/')}}/" + id,
 ...
 $(function() {
    $('.coursereviewstatus').change(function() {
