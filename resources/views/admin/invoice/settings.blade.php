          ...
          <div class="row">
            ...
            <div class="form-group col-md-6"> 
              ...
              <select class="form-control select2" name="border_style">
                ...
                <option {{ optional($settings)->border_style == 'dashed' ? 'selected' : ''}} value="dashed">Dashed</option>

                <option {{ optional($settings)->border_style == 'solid' ? 'selected' : ''}} value="solid">Solid</option>

                <option {{ optional($settings)->border_style == 'groove' ? 'selected' : ''}} value="groove">groove</option>

                <option {{ optional($settings)->border_style == 'double' ? 'selected' : ''}} value="double">double</option>
            ...
            <div class="form-group col-md-6"> 
              ...
              <select class="form-control select2" name="date_format">
                ...
                <option {{ optional($settings)->date_format == 'd-m-Y' ? 'selected' : ''}} value="d-m-Y">d-m-Y</option>

                <option {{ optional($settings)->date_format == 'd/m/Y' ? 'selected' : ''}} value="d/m/Y">d/m/Y</option>

                <option {{ optional($settings)->date_format == 'Y-m-d' ? 'selected' : ''}} value="Y-m-d">Y-m-d</option>

                <option {{ optional($settings)->date_format == 'jS F Y' ? 'selected' : ''}} value="jS F Y">jS F Y</option>

                <option {{ optional($settings)->date_format == 'jS F Y' ? 'selected' : ''}} value="jS F Y">jS F Y</option>

                <option {{ optional($settings)->date_format == 'jS F Y' ? 'selected' : ''}} value="jS F Y">jS F Y</option>
                
                <option {{ optional($settings)->border_style == 'jS F Y' ? 'selected' : ''}} value="jS F Y">jS F Y</option>
