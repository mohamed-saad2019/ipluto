        ...
        <div class="card m-b-30">
                ...
                <div class="card-body">
				   ...
				   <form action="{{ action('AboutController@update') }}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row" style="{{ $data['four_enable']==1 ? '' : 'display:none' }}" id="sec_four">
						                ...
						                {{-- <div class="col-md-6">
						                   	<label class="text-dark" for="four_btntext">{{ __('Section Four Button Text :') }} <span class="text-danger">*</span></label>
							...
							<div class="row">
								<div class="col-md-12">
			                        <label class="text-dark" for="six_enable">Section Six</label><br>
