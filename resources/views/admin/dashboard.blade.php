            ...
            <div class="row">
                            ...
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p>{{ $topusers->email }}</p>
                                        <p><span class="badge badge-primary-inverse">Verified:{{ $topusers->verified }}</span>
                                        </p>
                            ...
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p><span
                                                class="badge badge-primary-inverse">Verified:{{ $topinstructors->verified }}</span>
                                        </p>
                                ...
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p>
                                            ...
                                            <span class="badge badge-primary-inverse">Price:{{ $topcourses->price }}</span>
                                            @else
                                            <span class="badge badge-primary-inverse">Price:{{ $topcourses->discount_price }}</span>
                                            @endif
                                        </p>
                ...
                <div class="col-lg-12 col-xl-3 mt-md-3">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0">Top Order</h5>
                                </div>
                            ...
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <div class="card-body text-center">
                                        ...
                                        <p><span
                                                class="badge badge-primary-inverse">Price:{{ $toporders->amount }}</span>
                                        </p>
                ...
                <div class="col-md-12">
                    <div class="card m-b-30 mt-md-2">
                        <div class="card-header">
                            <h5 class="card-title">Monthly Registreed Users in 2021</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4 mt-5">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h5 class="card-title mb-0">Instructor Request</h5>
                                </div>
                                <div class="col-3">
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 font-18 float-right" type="button"
