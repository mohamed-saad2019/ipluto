                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label class="text-dark">{{ __('adminstaticword.AppName') }}: </label>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label class="text-dark" >{{ __('adminstaticword.ThemeColorforheader') }} : </label>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="text-dark" for="">{{ __('adminstaticword.BackgroundColor') }} :</label>
