                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                      <div class="form-group">
                                          <label class="text-dark">PWA {{ __('adminstaticword.Icon') }} (512x512) : <span class="text-danger">*</span> </label>           
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <label class="text-dark">PWA {{ __('adminstaticword.SplashScreen') }} (2048x2732) : <span class="text-danger">*</span> </label>
