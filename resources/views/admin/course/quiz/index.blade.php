...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
      @if($topic->type == NULL)
      <a href="{{ route('import.quiz') }}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Import Quiz</a>
        <a data-toggle="modal" data-target="#myModalquiz" href="#"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Add Question</a>
        @endif

        @if($topic->type == '1')
        <a data-toggle="modal" data-target="#myModalquizsubject"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>Add Question</a>
@endif
    </div>                        
</div>
@endslot
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="box-title">All Quiz</h5>
              </div>
              <div class="card-body">
                              ...
                              <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                      @if($topic->type == NULL)
                                        <a class="dropdown-item"  data-toggle="modal" data-target="#myModaledit{{$quiz->id}}" ><i class="feather icon-edit mr-2"></i>Edit</a>
                                        @endif
                                        @if($topic->type == '1')
                                        <a class="dropdown-item" data-toggle="modal" data-target="#myModaleditsub{{$quiz->id}}" href="#"><i class="feather icon-edit mr-2"></i>Edit</a>
                                        @endif
                                        ...
                                        <form id="demo-form2" method="POST" action="{{route('questions.update', $quiz->id)}}"
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group{{ $errors->has('question_video_link') ? ' has-error' : '' }}">
                                              ...
                                              <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> YouTube And Vimeo Video Support (Only Embed Code Link)</small>
                                            </div>
                                            </div>
                                            <div class="col-md-6">
                                              <div class="col-md-12">
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                  <div
                                                    ...
                                                    <label for="exampleInputDetails">Add Video To Question :<sup
                                                        class="redstar">*</sup></label>
                                                    ...
                                                    <small class="text-danger">{{ $errors->first('question_video_link') }}</small>
                                                    <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>YouTube And Vimeo Video Support (Only Embed Code LinkG</small>
                                                ...
                                                <div class="col-md-6">
                                                  <div class="form-group{{ $errors->has('question_img') ? ' has-error' : '' }}">
                                                    ...
                                                    <label for="exampleInputDetails">Add Image To Question :<sup
                                                        class="redstar">*</sup></label>
                                                    <input type="file" name="question_img" class="form-control" />
            
            
                                                    <small class="text-danger">{{ $errors->first('question_img') }}</small>
                                                    <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> Please Choose Only .JPG, .JPEG and .PNG</small>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
