    ...
    <div class="card m-b-30">
      ...
      <button type="button" class="btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete8"><i
        ...
        <a data-toggle="modal" data-target="#myModalabcdef" href="#" class="btn btn-primary-rgba"><i
            class="feather icon-plus mr-2"></i>Announcement</a>
      </div>
      <div class="card-body">
          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            ...
            <tbody>
              ...
              <tr>
                ...
                <!-- <td>
                  <input data-id="{{$an->id}}" type="checkbox" name="status" class="custom_toggle ancourse1234"
                    {{ ($an->status == 1 ) ? 'checked' : ''}} onchange="ancourse1234('{{$an->id}}')" />
                </td> -->
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                        <a class="dropdown-item" href="{{url('announsment/'.$an->id)}}"><i class="feather icon-edit mr-2"></i>Edit</a>
               ...
               <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <!-- <input id="status_toggle" type="checkbox" class="custom_toggle" name="status" checked/>
                    <input type="hidden" name="status" value="0" for="status" id="uuuuu">
                 -->
                </div>
  ...
  function ancourse1234(id){
    ...
    var status = $(this).prop('checked') == true ? 1 : 0; 
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{url('/announcement/status/')}}/" + id,
