      ...
      <form action="{{route('course.update',$cor->id)}}" method="post" enctype="multipart/form-data">
              ...
              <br>
                ...
                <div class="col-md-4">
                  ...
                  <br>
                  <small class="text-info"><i class="fa fa-question-circle"></i> If enabled duration can be in months.</small><br>
                  <small class="text-info"> when Disabled duration can be in days.</small>
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label" for="first-name">Image <span
                        ...
                        <small class="text-info"> <i class="text-dark feather icon-help-circle"></i>(Choose Image for 
                          post)</small>
                        <br>
              ...
              <div class="col-sm-3">
                  ...
                  <br>
                  <small class="text-info"><i class="fa fa-question-circle"></i> To enable assignment on portal
                  </small>
                ...
                <div class="col-sm-3">
                  ...
                  <br>
                  <small class="text-info"><i class="fa fa-question-circle"></i> To release content on chapter & classes by a specific date or amount of days after enrollment.
                  </small>
                </div>
            </div>
            <br>
