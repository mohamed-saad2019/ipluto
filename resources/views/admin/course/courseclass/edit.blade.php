...
<div class="col-md-4 col-lg-4">
  <a href="{{ url('course/create/'. $cate->courses->id) }}" class="float-right btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>Back</a>
</div>
@endslot
@endcomponent
          ...
          <form enctype="multipart/form-data" id="demo-form" method="post" action="{{url('courseclass/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="row">
              ...
              <div class="col-md-4"> 
                ...
                <!-- ============== -->
                <!-- <input id="featured" type="checkbox" class="custom_toggle" name="featured"
