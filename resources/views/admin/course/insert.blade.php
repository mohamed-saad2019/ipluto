    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-tittle">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.Lesson') }}</h5>
        </div>
        <div class="card-body">
          <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <small class="text-muted"><i class="fa fa-question-circle"></i> If enabled duration can be in months,</small>
                <small class="text-muted"> when Disabled duration can be in days.</small>
              <br>   
