      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="box-title">All Assignments</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="table-responsive">
                      ...
                      <td><div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                            <a class="dropdown-item" href="{{url('assignment/'.$assign->id)}}"><i class="feather icon-eye mr-2"></i>View</a>
                            <a class="dropdown-item" href="{{ asset('files/assignment/'.$assign->assignment) }}"  download="{{$assign->assignment}}"><i class="feather icon-download mr-2"></i>Download</a>
