...
<div class="col-md-4 col-lg-4">
  <a href="{{ url('course/create/'. $que->courses->id) }}" class="float-right btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>Back</a>
</div>
@endslot
​
@endcomponent
            ...
            <div class="row">
              ...
              <div class="col-md-12 mt-3">
                <label for="exampleInputTit1e">{{ __('adminstaticword.Status') }}:</label><br>
                  ...
                  <!--<input class="custom_toggle" id="cb77" type="checkbox" {{ $que->status==1 ? 'checked' : '' }}>-->
