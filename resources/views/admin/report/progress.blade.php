      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="card-box">All Progress</h5>
              </div>
              <div class="card-body">
                        ...
                        <div class="btn-group mr-2">
                          <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                  <a class="dropdown-item" href="{{url('progress/report/'.$pro->id)}}" class="btn btn-xs btn-success-rgba"><i class="feather icon-eye mr-2"></i>View</a>
                                  </div>
                      </div>
                    </td>
                      </tr>
