    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <ul class="nav nav-tabs mb-3" id="defaultTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#google" role="tab" aria-controls="profile" aria-selected="false">{{ __('Front Static Word Translation') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#twitter" role="tab" aria-controls="profile" aria-selected="false">{{ __('Admin Static Word Translation') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#linkedin" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;{{ __('Flash Message Translation') }}</a>
                        </li>
                    </ul>
