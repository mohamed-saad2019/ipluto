...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
      <a href="page-product-detail.html" class="btn btn-danger-rgba"  data-toggle="modal" data-target=".bd-example-modal-sm1"><i class="feather icon-trash mr-2"></i>Delete Selected</a>
        ...
        <a data-toggle="modal" data-target="#myModaljjh" href="#" class="btn btn-primary-rgba mr-2" ><i class="feather icon-plus mr-2"></i>Add Language</a>
...
<script>
  $(function() {
    $('.courselanguage').change(function() {
