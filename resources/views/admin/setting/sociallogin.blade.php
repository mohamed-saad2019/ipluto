					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('adminstaticword.ClientID') }} :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('adminstaticword.ClientSecretKey') }}:</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark">{{ __('adminstaticword.CallbackURL') }} :</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="text-dark" for=""><i class="fa fa-facebook-square"></i> {{ __('adminstaticword.EnableFacebookLogin') }} :</label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="{{ route('sl.gl') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-google"></i> {{ __('adminstaticword.EnableGoogleLogin') }} : </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="{{ route('sl.git') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-gitlab"></i> {{ __('adminstaticword.EnableGitLabLogin') }}: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="{{ route('sl.amazon') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-amazon"></i> {{ __('adminstaticword.EnableAmazonLogin') }}: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="{{ route('sl.linkedin') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-linkedin"></i> {{ __('adminstaticword.EnableLinkedLogin') }}: </label><br>
				...
				<div class="card-body">
					...
					<form class="form" action="{{ route('sl.twitter') }}" method="POST" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="text-dark" for=""><i class="fa fa-twitter"></i> {{ __('adminstaticword.EnableTwitterLogin') }}: </label><br>
									<input type="checkbox" class="custom_toggle" name="twitter_enable" {{ $setting->twitter_enable == 1 ? 'checked' : "" }} />
									<input type="hidden"  name="free" value="0" for="status" id="status">
									<!-- <div class="custom-control custom-switch">
										<input type="checkbox" value="0" name="twitter_enable" class="custom-control-input" id="customSwitch36" {{ $setting->twitter_enable == 1 ? 'checked' : "" }} >
