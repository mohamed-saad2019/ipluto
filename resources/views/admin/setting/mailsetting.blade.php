<form action="{{ route('update.mail.set') }}" method="POST">
	...
	<div class="row">
		<div class="col-md-6">
            ...
            @endif
            <br>
            <label class="text-dark" for="">{{ __('adminstaticword.MAILDRIVER') }} : (ex. SMTP, MAIL, SENDMAIL)</label>
            ...
            @endif
            <br>
            <label class="text-dark" for="">{{ __('adminstaticword.MAILHOST') }} : <span class="text-danger">*</span> (ex. smtp.mailtrap.io)</label> 
            ...
            @endif
            <br>
            <label class="text-dark" for="">{{ __('adminstaticword.MAILPORT') }} : <span class="text-danger">*</span> (ex. 2525,467)</label>
        ...
        <div class="col-md-6">
            ...
            @endif
            <br>
            <label class="text-dark" for="">{{ __('adminstaticword.MAILUSERNAME') }} : <span class="text-danger">*</span> (ex. info@test.com)</label>
            ...
            <div class="row">
                ...
                @endif
            <br>
            <label class="text-dark" for="">{{ __('adminstaticword.MAILENCRYPTION') }} : (ex. TLS/SSL)</label>
