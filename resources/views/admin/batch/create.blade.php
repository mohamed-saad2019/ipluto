            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group col-md-6">
                  <label>{{ __('adminstaticword.Image') }}:<sup class="redstar">*</sup></label><p class="inline info">size: 250x150</p>                  <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('adminstaticword.Recommendedsize') }} (1375 x 409px)</small>
