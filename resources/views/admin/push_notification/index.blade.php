                    ...
                    <form action="{{ route('admin.push.notif') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-info">
                                <i class="fa fa-question-circle"></i> On click of notification where you want to
                                redirect the user.
                            </small>
                        </div>
                        <div class="form-group">
                            ...
                            <small class="text-info">
                                <i class="fa fa-question-circle"></i> If not enter than default icon will use which you
                                upload at time
                        ...
                        <div style="display: {{ old('show_button') ? 'block' : 'none' }};" id="buttonBox">
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted">
                                    <i class="fa fa-question-circle"></i> On click of button where you want to redirect
                                    the user.
                                </small>
                            </div>
                        </div>
