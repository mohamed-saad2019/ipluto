        ...
        <div class="navigation fullscreen-search-block">
            ...
            <div class="logo">
                ...
                @if($gsetting->logo_type == 'L')
                    <a href="{{ url('/') }}" ><img src="{{url('images/logo.png')}}" class="img-fluid" alt="logo"></a>
                @else()
                ...
                <div class="sidebar-nav-icon">
                    <ul>
                        ...
                        @if(Schema::hasTable('affiliate') && Schema::hasTable('wallet_settings'))
                            ...
                            <a href="{{ url('/wallet') }}"><li><i class="fas fa-wallet"></i>{{ __('frontstaticword.MyWallet') }}</li></a>
                            @endif

                            @if(isset($affiliate) && $affiliate->status == 1)
                            <a href="{{ route('get.affiliate') }}"><li><i class="fas fa-users"></i>{{ __('frontstaticword.Affiliate') }}</li></a>
                            @endif
                        ...
                        <div class="my-container">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open" aria-labelledby="dropdownMenu1">
                                ...
                                <a target="_blank" href="{{route('admin.index', $gsetting->admin_url)}}"><li><i class="fa fa-dashboard"></i>{{ __('frontstaticword.AdminDashboard') }}</li></a>
                                @else
                                <a target="_blank" href="{{ url('/admins') }}"><li><i class="fa fa-dashboard"></i>{{ __('frontstaticword.AdminDashboard') }}</li></a>
                                @endif
                                @endif
                                ...
                                <a href="{{ route('compare.index') }}"><li><i class="fa fa-gavel"></i>{{ __("Compare") }}</li></a>
