                        ...
                        <div class="form-group  form1">
                            <div class="d-flex justify-content-between">
                                <div class="lessonName">
                                    <input type="hidden" type="text" id="lesson_id" value="{{$lesson->id}}"
                    ...
                    <div class="shadow p-3 mb-5 rounded-lg">
                        <div class="row">
                            ...
                            <div class="accordion col-md-9 form1">
                                <select class="form-control choosedClass" id="c_{{$class->id}}" name="class_id[]"
                                    required>
        ...
        <form method="post" action="{{route('saveShare')}}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 d-flex align-content-center">
                    ...
                    <input type="hidden" id="lesson_id" value="356" class="form-control" name="lesson_id">
                </div>
            </div>
            <!-- End Lesson Name -->
