          ...
          <h3 style="margin-bottom:5px"><span id='change_name'>{{$full_name}} </span> 
            ...
            @endif
              ...
              <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#exampleModalCenter" style="margin:0px 10px;">
                <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg"><g fill="#fff" fill-rule="nonzero"><path d="M11.22 3.616l2.944 2.947-9.477 9.47-2.945-2.948zM14.122.594l2.945 2.95-2.475 2.47-2.945-2.95zM4.357 16.498l-2.942-2.997-.517 2.42 1.305 1.332zM.485 17.854l1.152-.403-.876-.893z"></path></g></svg> Settings
              </button>
    ...
    <div class="modal-content" style="width:650px!important;padding: 20px;">
      ...
      <div class="modal-body">
        ...
        <div class="row">
              ...
              <div class="col-md-12">
                <input type="text" class="form-control" name="name" id="one" required='required'
                 value="{{$full_name}}"  
...
<div class="popFolder">
<div class="modal fade modal" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!--                   <p style="">Add content to your lesson</p>
 -->                    <div class="row">
                       ...
                       <!-- <div class="col-6 col-md-4 col-lg-3 IconCont">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='video'
                        data-ex = 'video/*' data-text='Upload a Video File'
                                            data-type='fa-play-circle'>
                            <i class="fas fa-play-circle"></i>
                            <h6>Video</h6>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='audio'
                        data-ex = 'audio/*' data-text='Upload a Audio File'
                                            data-type='fa-volume-up'>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='pdf'
                        data-ex = 'application/pdf' data-text='Upload a PDF File'
                                                    data-type='fa-file-pdf'>
                            <i class="far fa-file-pdf"></i>
                            <h6>PDF Viewer</h6>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='ppt'
                        data-ex = '.ppt,.pptx'      data-text='Upload a Power Point File'
                                                    data-type='fa-file-powerpoint'>
                            <i class="fas fa-file-powerpoint"></i>
                            <h6>Power Point</h6>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='doc'
                        data-ex = '.doc,.docx'  data-text='Upload a Word File'
                                                    data-type='fa-file-word'>
                            <i class='fas fa-file-word'></i>
                            <h6>Word</h6>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id='xsl'
                        data-ex = '.xls,.xlsx,.csv' data-text='Upload a Excel File'
                                                    data-type='fa-file-excel'>
                            <i class='fas fa-file-excel'></i>
                            <h6>Excel</h6>
                        </div>
                        <div class="col-6 col-md-4 col-lg-3 IconCont check" id="img"
                         data-ex = 'image/*' data-text='Upload a Slideshow Files'
                                                    data-type='fa-file-image'>
...
<div class="modal fade" id="exampleModalCenter8" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" >
    <div class="modal-content" style="width:650px!important;padding: 20px;">
...
<div class="modal fade" id="exampleModalCenter7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" >
                    ...
                    if(data==-1)
                     {
                         ...
                         $('.msg_lesson p').text('Error Lesson Name: Required, must not be numeric, must contain at least 3 or no more than 255 characters.');
                     }
